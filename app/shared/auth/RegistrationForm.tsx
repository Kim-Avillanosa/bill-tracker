      ...
      <Form onSubmit={formik.handleSubmit}>
        ...
        <FormGroup>
          ...
          <FormControl
            ...
            isInvalid={formik.touched.bank_name && Boolean(formik.errors.bank_name)}
          />
        ...
        <FormGroup>
          ...
          <FormControl
            ...
            isInvalid={formik.touched.bank_swift_code && Boolean(formik.errors.bank_swift_code)}
          />
        ...
        <FormGroup>
          ...
          <FormControl
            ...
            isInvalid={formik.touched.bank_account_number && Boolean(formik.errors.bank_account_number)}
          />
          {formik.touched.bank_account_number && (
            <div className="text-danger">{formik.errors.bank_account_number}</div>
          )}
        </FormGroup>
        ...
        <FormGroup>
          ...
          <FormControl
            ...
            isInvalid={formik.touched.bank_account_name && Boolean(formik.errors.bank_account_name)}
          />
          {formik.touched.bank_account_name && (
            <div className="text-danger">{formik.errors.bank_account_name}</div>
          )}
        </FormGroup>
