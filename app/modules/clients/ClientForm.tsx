...
const ClientForm: React.FC<ClientFormProps> = ({ initialData, isUpdate = false }) => {
        ...
        <Container className="">
            <Form onSubmit={formik.handleSubmit}>
                ...
                <FormGroup>
                    ...
                    />
                    {formik.touched.code && <div className="text-danger">{formik.errors.code}</div>}
                </FormGroup>
                <FormGroup>
                    ...
                    />
                    {formik.touched.symbol && <div className="text-danger">{formik.errors.symbol}</div>}
                </FormGroup>
                <FormGroup>
                ...
                <FormGroup>
                    ...
                    <FormControl
                        ...
                        isInvalid={formik.touched.hourly_rate && Boolean(formik.errors.hourly_rate)}
                    />
                    {formik.touched.hourly_rate && <div className="text-danger">{formik.errors.hourly_rate}</div>}
                </FormGroup>
                <FormGroup>
                    ...
                    <FormControl
                        ...
                        isInvalid={formik.touched.hours_per_day && Boolean(formik.errors.hours_per_day)}
                    />
                    {formik.touched.hours_per_day && <div className="text-danger">{formik.errors.hours_per_day}</div>}
                </FormGroup>
                <FormGroup>
                    ...
                    />
                    {formik.touched.category && <div className="text-danger">{formik.errors.category}</div>}
                </FormGroup>
                <FormGroup>
                    ...
                    <FormControl
                        ...
                        isInvalid={formik.touched.banner_color && Boolean(formik.errors.banner_color)}
                    />
                    {formik.touched.banner_color && <div className="text-danger">{formik.errors.banner_color}</div>}
                </FormGroup>
                <FormGroup>
                    ...
                    <FormControl
                        ...
                        isInvalid={formik.touched.headline_color && Boolean(formik.errors.headline_color)}
                    />
                    {formik.touched.headline_color && <div className="text-danger">{formik.errors.headline_color}</div>}
                </FormGroup>
                <FormGroup>
                    ...
                    <FormControl
                        ...
                        isInvalid={formik.touched.text_color && Boolean(formik.errors.text_color)}
                    />
